...
//						System.out.println(vehicleSubarray[j].getTotalTravelTime());
//						test[i][j] = vehicleSubarray[j].getTotalTravelTime();
					}
				}
...
//					System.out.println(length + " : length");
					for (j = 0; j < length; ++j) {
						vehicle = vehicleSubarray[j];
						int c = vehicle.getChromosome();
//						testTime = new TestTime(i,j, vehicle.getTotalTravelTime());

					// Lock on thread Solved!

						synchronized (lock) {
//							testTime = new TestTime(i,j, vehicleSubarray[j].getTotalTravelTime());

//							System.out.println("c: " + c);
							if (vehicle.getTotalTravelTime() > 0) {
//									System.out.println(j + " " + vehicle.getTotalTravelTime());
//									System.out.println("chromosome: " + vehicle.getChromosome());
//								chromeTime[c] = vehicle.getTotalTravelTime();
//								System.err.println("chromeTime: " + chromeTime[c]);
							}
